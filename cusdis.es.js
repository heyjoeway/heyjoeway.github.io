if (window.CUSDIS === undefined) {
  ...
  window.CUSDIS = {};
  window.makeIframeContent = (target) => {
  ...
  window.singleTonIframe = undefined;
  window.createIframe = function(target) {
    if (!singleTonIframe) {
  ...
  window.postMessage = function(event, data) {
    if (singleTonIframe) {
  ...
  window.listenEvent = function(iframe, target) {
