import{a as N,t as G}from"../chunks/disclose-version.D_1LDZzU.js";import"../chunks/legacy.C2vTGYZR.js";import{aw as Qt,j as Jt,W as Xt,V as Yt,p as Ht,t as z,d as X,a as Vt,c as r,s as a,r as s,ax as A,ay as $t,f as te,g as t,ab as _,ad as f}from"../chunks/runtime.IuhaTYL2.js";import{s as o}from"../chunks/render.DHeeOFH9.js";import{e as Ot,i as Ut}from"../chunks/each.BFWpi5Ml.js";import{s as q}from"../chunks/attributes.TNdRqFfH.js";import{i as Ft}from"../chunks/lifecycle.Be19xgK4.js";import{p as y,l as ee,s as ae}from"../chunks/props.wXQSvOuq.js";import{M as re}from"../chunks/MdsvexLayout.D5nZddVV.js";import{s as Rt}from"../chunks/Utils.WwW4-Fab.js";import{i as se}from"../chunks/if.C1PrGVlD.js";import{l as ie,b as ne,e as Ct,c as de}from"../chunks/events.BxMnuzEr.js";/* empty css                                                       */import{C as ct}from"../chunks/Code.CRmZZ-LJ.js";function me(i,m,C=m){var S=Qt();ie(i,"input",v=>{var u=v?i.defaultValue:i.value;if(u=kt(i)?xt(u):u,C(u),S&&u!==(u=m())){var H=i.selectionStart,V=i.selectionEnd;i.value=u??"",V!==null&&(i.selectionStart=H,i.selectionEnd=Math.min(V,i.value.length))}}),(Jt&&i.defaultValue!==i.value||Xt(m)==null&&i.value)&&C(kt(i)?xt(i.value):i.value),Yt(()=>{var v=m();kt(i)&&v===xt(i.value)||i.type==="date"&&!v&&!i.value||v!==i.value&&(i.value=v??"")})}function kt(i){var m=i.type;return m==="number"||m==="range"}function xt(i){return i===""?null:+i}var le=G('<label class="svelte-16b6hx2"> </label>'),oe=G('<div class="svelte-16b6hx2"><!> <textarea class="svelte-16b6hx2"></textarea></div>');function ht(i,m){Ht(m,!1);let C=y(m,"value",12,""),S=y(m,"label",8,""),v=y(m,"name",8,""),u=y(m,"width",8,"100%"),H=y(m,"height",8,"300px"),V=y(m,"rows",8,10),Y=y(m,"placeholder",8,""),$=y(m,"autofocus",8,!1),tt=y(m,"onInput",8,()=>{}),h=y(m,"onKeydown",8,()=>{}),D=y(m,"wrap",8,!0);Ft();var b=oe(),B=r(b);{var F=k=>{var p=le(),R=r(p,!0);s(p),z(()=>{q(p,"for",v()),o(R,S())}),N(k,p)};se(B,k=>{S()&&k(F)})}var c=a(B,2);de(c),ne(c,$()),s(b),z(k=>{q(c,"name",v()),q(c,"placeholder",Y()),q(c,"rows",V()),q(c,"style",k)},[()=>Rt({width:u(),height:H(),"min-width":u(),"max-width":u(),"text-wrap":D()?"wrap":"nowrap"})],X),me(c,C),Ct("input",c,function(...k){var p;(p=tt())==null||p.apply(this,k)}),Ct("keydown",c,function(...k){var p;(p=h())==null||p.apply(this,k)}),N(i,b),Vt()}const ue={title:"Tools: Proxmox Memory Info",comments:!0,categories:"tools proxmox software"};var pe=G('<tr><td></td><td> </td><td> </td><td> </td><td> </td><td style="text-align:right"> </td><td style="text-align:right"> </td></tr>'),ve=G('<tr><td></td><td> </td><td> </td><td>qemu</td><td> </td><td style="text-align:right"> </td><td style="text-align:right"> </td></tr>'),ce=G('<p>Proxmox doesn’t have a built-in way to check if you’re overcommitting memory on your host. (That I know of?) This is a simple tool that gives you a summary of your memory usage using some shell commands and copypasta.</p> <h2 class="h2-1">Paste the output of…</h2> <!> <p>down here:</p> <!> <h2 class="h2-2">Paste the output of…</h2> <!> <p>down here:</p> <!> <h2 class="h2-3">Paste the output of…</h2> <!> <p>down here:</p> <!> <h2 class="h2-4">Results</h2> <table><thead><tr><th></th><th>VM ID</th><th>Name</th><th>Type</th><th>Status</th><th style="text-align:right">Current Mem.</th><th style="text-align:right">Max Mem.</th></tr></thead><tbody><!><!><tr><td><b>Totals</b></td><td></td><td></td><td></td><td></td><td style="text-align:right"><b> </b></td><td style="text-align:right"><b> </b></td></tr></tbody></table> <table><tbody><tr><th>Current System Memory Usage</th><td> </td></tr><tr><th>Memory Used by Host</th><td> </td></tr><tr><th>Max Potential Memory Use</th><td> </td></tr><tr><th>Total Host Memory</th><td> </td></tr><tr><th>Available for Provisioning</th><td> </td></tr></tbody></table>',1);function Ie(i,m){const C=ee(m,["children","$$slots","$$events","$$legacy"]);Ht(m,!1);let S=f(`      VMID NAME                 STATUS     MEM(MB)    BOOTDISK(GB) PID       
